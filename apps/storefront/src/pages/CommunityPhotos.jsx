    ...
    <main className="flex-grow bg-white px-4 py-14 sm:py-20">
      <section className="mx-auto max-w-5xl">
        ...
        <form onSubmit={handleUpload} className="max-w-md mx-auto mb-12 p-6 rounded-3xl border border-gray-100 shadow-sm space-y-4">
          ...
          <label className="block text-sm font-bold text-gray-700">Image URL <input value={imageUrl} onChange={(e) => setImageUrl(e.target.value)} className="form-input w-full mt-1 rounded-xl border border-gray-200 px-4 py-2.5 text-sm outline-none focus:border-brand-pink" placeholder="https://..." autoComplete="url" required /></label>
          <label className="block text-sm font-bold text-gray-700">Email <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="form-input w-full mt-1 rounded-xl border border-gray-200 px-4 py-2.5 text-sm outline-none focus:border-brand-pink" autoComplete="email" required /></label>
          <label className="block text-sm font-bold text-gray-700">Caption <input value={caption} onChange={(e) => setCaption(e.target.value)} className="form-input w-full mt-1 rounded-xl border border-gray-200 px-4 py-2.5 text-sm outline-none focus:border-brand-pink" autoComplete="off" /></label>
