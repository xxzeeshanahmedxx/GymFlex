...
export function normalizeApiProduct(product, variants = [], images = [], lookProducts = []) {
  return {
    ...
    on_sale: Boolean(product.on_sale ?? product.onSale),
    ...
    is_preorder: Boolean(product.is_preorder ?? product.isPreorder),
    preorder_release_date: product.preorder_release_date || null,
